...
class Level3: Level {
    ...
    override func didMoveLevelSpecific() {
        ...
        self.addChild(Background(backgroundPic: "lv3_1.png"))
        // set up static ground
        self.baseGround = GroundBase(img: "lv3_2.png")
        self.addChild(self.baseGround!)
        
        self.floatGround = GroundFloat(posX: 0.078, posY: 0.243, img: "lv3_3.png")
